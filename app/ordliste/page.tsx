  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-8 justify-between bg-pink-100">
      ...
      <div className="m-16 p-8">
        ...
        <br />
        <br />
        Ord og begreper som er valgt ut har tema fødsel, helsevesen og samfunn.
        Selv om frifødsel er i sentrum har noen av begrepene med sykehusfødsel å
        gjøre. Dette er for å synliggjøre kontrasten og for at spenningen mellom
        trygghet og risiko, skadepotensial og realiseringspotensial, skal
        anerkjennes i alle typer fødsel. Sett fra vårt aktivistiske perspektiv
        er hverken frifødsel eller sykehusfødsel bare «trygt» eller bare
        «farlig», og vi inviterer leseren til å innta en både-og-holdning
        gjennom hele ordlisten.
        <br />
        <br />
        Ordlisten tar sikte på å ha et tydelig perspektiv, ikke en objektiv
        distanse til begrepene som omtales. Ordene utgjør ingen helhet til
        sammen, og er som et stykke tøy med huller som sikkert skulle vært
        stoppet, ikke et innrammet broderi. Bruk ordlisten som utgangspunkt for
      ...
      <Card className="m-16 p-8">
        <p className="text-black">
          ...
          ikke en del av en institusjon eller et profesjonelt system. En
        ...
        <p className="text-black">
          ...
          nødstilfeller. Hvis du har hatt en{" "}
          <span className="italic">vill graviditet</span> og møter fødende og i
          god form opp på en fødeinstitusjon med mål om en mest mulig
          uforstyrret fødsel, så setter du både deg selv og de som er på jobb i
          en vanskelig situasjon. De har ikke informasjonen de er vant til å
          jobbe ut ifra og må stemple deg som høyrisko og for eksempel be deg om
          å godta informasjonsgenererende teknologi slik som kontinuerlig
          fosterovervåkning, med alle ulempene det medfører.
          <br />
          <br />
          <br />
          <br />
        ...
        <p className="text-black">
          ...
          annet transportmiddel. I disse tilfellene kalles hendelsen en
          uplanlagt, uassistert fødsel. Om det skjer i en ambulanse er ikke
          fødselen uassistert, men likevel en transportfødsel.
          <br />
          <br />
          <br />
          <br />
        ...
        <p className="text-black">
          ...
          assistert av. Hvis jordmor ikke nådde frem i tide til å vitne eller
          bistå i en planlagt hjemmefødsel har det skjedd en uassistert fødsel,
          men jordmor vil da kunne gjøre helseundersøkelser når hun når frem og
          registrere barnet i Skatteetaten, altså assistere i noen grad.
          <br />
          <br />
          <br />
          <br />
        ...
        <p className="text-black">
          ...
          En fødsel som starter og fortsetter av seg selv helt til barnet og
          morkaken er kommet ut og hvor barnet finner brystet og begynner å die.
        ...
        <p className="text-black">
          ...
          Tiden mellom barnets ankomst og frem til moren tar eierskap over
        ...
        <p className="text-black">
          ...
          Den første timen etter barnets ankomst, der mor og barn er hud mot hud
          og barnet finner brystet. Dette er en spesiell tid for mor og barn, og
          er meget viktig for tilknytningen, ammingen og barnets helse videre.
          Hos mor frigjøres den største mengden oksytocin hun kanskje noen gang
        ...
        <p className="text-black">
          ...
          gjort en vurdering dithen at tilbudet er uønsket. <br />
        ...
        <p className="text-black">
          ...
          at dette nettverket er for «<span className="italic">
            kvinner{" "}
          </span>{" "}
          som har direkte erfaring med vill graviditet og frifødsel», så gjør
          konteksten det åpenbart at vi refererer til ciss-kvinner.
        ...
        <p className="text-black">
          ...
          oppstår, men kroppen er et autopoetisk liv, ikke en maskin. Det vi
        ...
        <p className="text-black">
          ...
          Den dagen de fleste kvinner er frifødere kunne vi hatt omreisende
          fødselsambulanser å tilkalle i de få tilfellene de trengtes. Dette
        ...
        <p className="text-black">
          ...
          Organisasjoner som jobber for en bedre fødselsomsorg. De respekterer
        ...
        <p className="text-black">
          ...
          kvinner over gjennom svangerskapet, og hjerteknusende omfavnes det som
          en potensiell virkelighet. Det finnes flere podkast-episoder med
