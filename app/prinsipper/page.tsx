  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between bg-pink-100">
      <Card className="m-16 p-8 lg:w-[80vw] w-[100vw]">
        ...
        utgjorde nettverket i begynnelsen.
        <br />
        <br />
      ...
      <Card className="m-16 p-8">
        ...
        <br />
        <br />
        - Samtidig som det er bestemt at mennesker juridisk sett er et
        ...
        <br />
        <br />
        - Vi ærer urinstinkter, egen iboende kraft og en rå tilnærming til
        fødsel i tillit. Vi hedrer intuisjon og anser det som en ressurs vi kan
        øve opp og utfolde.
        <br />
        <br />
        - Vi har utøvet, vil utøve eller støtter utøvelsen av vill graviditet og
        frifødsel. Vi gjør frie fødsler og lever frie liv i radikalt selvansvar.
        <br />
        <br />
        - En enkel forberedelse på å friføde er å være frifødt selv. Det er i
        ...
        <br />
        <br />
        - Påbegynte frifødsler skal møtes med omsorg og forståelse av
        helsepersonell.
        <br />
        <br />
        - Vi skal ha et helsevesen og en sosialtjeneste med full aksept for vill
        graviditet og frifødsel, som møter frifødte barn med varsomhet og
        omsorg.
        <br />
        <br />
        - Skatteetaten skal legge til rette for enkel registrering av frifødte
        barn, som sikrer barnets rett til personnummer, navn og statsborgerskap.
        <br />
        <br />
        - Vi fasiliterer kvinnesirkler for fellesskap, søsterskap og resonnans
        ...
        arbeidsgiver har lov til å gi medisinske råd og utøve medisinske
        intervensjoner.
        <br />
        <br />
        ...
        <br />
        <br />
        - Ingen fanges eller defineres av kun én kontekst, men eksisterer i
        ...
        <br />
        <br />
        - Vi er sterkest når vi både gjør vår egen greie, og er sammen med de
        som styrker oss. Forening og adskillelse er i balanse i nettverket.
        <br />
        <br />
        - Vi er for personlig integritet, respektfulle uenigheter og frie
        ...
        <br />
        <br />
        - Vi er kulturkritiske og ser på vårt eget samfunn, kultur og historiske
        øyeblikk med en hobbyantropologisk distanse.
        <br />
        <br />
        ...
        <br />
        <br />
        - Vi alle har et behov for omsorg. Den offentlige, storskala
        svangerskapsoppfølgingen som utføres av profesjonelle fremmede kan
        optimaliseres, men aldri tilfredsstille oss på den måte fellesskap med
        ...
        <br />
        <br />
        - Jeg og mine barn er ikke udødelige. Vi er dødelige alle sammen, og
        både det siste og det første pust skal holdes hellig. Døden er en del av
        livets syklus.
        <br />
        <br />
        - Menstruasjonsblod og blodet som viser seg under og etter fødselen er
        rent, vakkert og livgivende.
        <br />
        <br />
        - En frifødsel speiler den kjærlighetsfylte, hjemmekoselige og private
